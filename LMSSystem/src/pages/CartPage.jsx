    ...
    <CartWrapper>
      <div className="container">
        ...
        <div className="cart-grid grid">
          ...
          <div className="cart-grid-left">
            <div className="flex flex-wrap flex-between">
              <div className="cart-count-info">
                <span className="fw-7 fs-18">{total_items} Course in cart</span>
              </div>
              <button type="button" className="cart-clear-btn flex fs-15 fw-6">
                <MdClear className="text-pink" />
                <span
                  className="d-inline-block text-pink"
                  onClick={() => clearCart()}
                >
                  Clear All
                </span>
          ...
          {/* end grid left */}
          {/*  grid right */}
          <div className="cart-grid-right grid">
